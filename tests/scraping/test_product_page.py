...
from scraping import ProductPageSpiderWorker
from scraping.product_page.functions import (
    get_avg_rating,
    get_brand,
    get_category,
    get_feature_bullets,
...
def test_ProductItemScraper(test_driver):
    """Test the ProductItemScraper."""

    scraper = ProductItemScraper(
        test_driver, starting_url="https://www.amazon.fr/dp/B082VVRKTP"
    )
    scraper.run()
    data = scraper.dump()
...
def test_ProductPageSpiderWorker(test_driver):
